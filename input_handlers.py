...
"""An event handler return value which can trigger an action or switch active event handlers."""
...
class BaseEventHandler(tcod.event.EventDispatch[ActionOrHandler]):
    ...
    def ev_quit(eslf, event: tcod.event.Quit) -> Optional[ActionOrHandler]:
        raise SystemExit()
